...
//   err := buf.WriteInt32()         // Write values
//   err := buf.WiteString("hello")
//   ...
//
...
func (b *WriteBuffer) WriteBytes(v []byte) error {
	*b = append(*b, v...)
	return nil
}
